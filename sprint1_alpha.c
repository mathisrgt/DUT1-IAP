...
// travailleurs ------------------------
/* La fonction traite_travailleurs() affiche l'entête de consultation des travailleurs pour une certaine spécialitée.
Nécessite l'entrée par l'utilisateur du nom de la spécialité. */
