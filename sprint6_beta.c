...
typedef struct {
	...
	int id_derniere_tache_progression;
...
typedef struct {
	...
	int id_derniere_commande_progression;
...
int attribution_tache(Specialites* ptr_specialites, Travailleurs* ptr_travailleurs, Commandes* ptr_commandes, int indice_specialite);
...
void traite_embauche(Specialites* ptr_specialites, Travailleurs* ptr_travailleurs) {
	...
	if (indice_travailleur == ptr_travailleurs->nb_travailleurs) {
		...
		travailleur.nb_taches_affectees = 0;
...
void traite_tache(Specialites* ptr_specialites, Travailleurs* ptr_travailleurs, Commandes* ptr_commandes) {
	...
	tache.id_travailleur = attribution_tache(ptr_specialites, ptr_travailleurs, ptr_commandes, indice_specialite);
...
int attribution_tache(Specialites* ptr_specialites, Travailleurs* ptr_travailleurs, Commandes* ptr_commandes, int indice_specialite) {
	int id_attribue = -1;
	int i = 0;
	int plus_grand_nb_taches_affectees;
	...
	for (i = 0; (id_attribue == -1) && (i < ptr_travailleurs->nb_travailleurs); ++i) {
		if (ptr_travailleurs->tab_travailleurs[i].tags_competences[indice_specialite] == VRAI) {
			id_attribue = i;
			plus_grand_nb_taches_affectees = ptr_travailleurs->tab_travailleurs[i].nb_taches_affectees;
			break;
		}
	}

	for (i = (id_attribue + 1); i < ptr_travailleurs->nb_travailleurs; ++i) {
		if ((ptr_travailleurs->tab_travailleurs[i].tags_competences[indice_specialite] == VRAI) && (ptr_travailleurs->tab_travailleurs[i].nb_taches_affectees < plus_grand_nb_taches_affectees)) {
			id_attribue = i;
			plus_grand_nb_taches_affectees = ptr_travailleurs->tab_travailleurs[i].nb_taches_affectees;
		}
	}

	++(ptr_travailleurs->tab_travailleurs[id_attribue].nb_taches_affectees);
...
void traite_passe(Specialites* ptr_specialites, Travailleurs* ptr_travailleurs, Commandes* ptr_commandes) {
	...
	--(ptr_travailleurs->tab_travailleurs[ptr_commandes->tab_commandes[id_commande].tache_par_specialite[id_specialite].id_travailleur].nb_taches_affectees);
	ptr_commandes->tab_commandes[id_commande].tache_par_specialite[id_specialite].id_travailleur = 0;
	ptr_commandes->tab_commandes[id_commande].tache_par_specialite[id_specialite].id_travailleur = attribution_tache(ptr_specialites, ptr_travailleurs, ptr_commandes, id_specialite);
}
